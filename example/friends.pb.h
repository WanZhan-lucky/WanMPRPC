...
class ResultCode :
 ...
 public:
  ...
  // uint32 errncode = 1;
  void clear_errncode();
  ::PROTOBUF_NAMESPACE_ID::uint32 errncode() const;
  void set_errncode(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_errncode() const;
  void _internal_set_errncode(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 errncode_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 ResultCode::_internal_errncode() const {
  return errncode_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 ResultCode::errncode() const {
  // @@protoc_insertion_point(field_get:fixbug.ResultCode.errncode)
  return _internal_errncode();
}
inline void ResultCode::_internal_set_errncode(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  errncode_ = value;
}
inline void ResultCode::set_errncode(::PROTOBUF_NAMESPACE_ID::uint32 value) {
