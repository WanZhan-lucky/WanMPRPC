...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_GetFriendsResponse_friends_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_GetFriendsResponse_friends_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_friends_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::fixbug::ResultCode, errncode_),
  ...
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::fixbug::GetFriendsRequest, id_),
  ~0u,  // no _has_bits_
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_friends_2eproto = {
  &descriptor_table_friends_2eproto_initialized, descriptor_table_protodef_friends_2eproto, "friends.proto", 289,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 8)) {
          errncode_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* ResultCode::_InternalSerialize(
  ...
  if (this->errncode() != 0) {
    ...
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteUInt32ToArray(1, this->_internal_errncode(), target);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:fixbug.ResultCode)
  ...
  if (from.errncode() != 0) {
    _internal_set_errncode(from._internal_errncode());
  }
}
...
void ResultCode::InternalSwap(ResultCode* other) {
  ...
  errmsg_.Swap(&other->errmsg_, &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
    GetArenaNoVirtual());
  swap(errncode_, other->errncode_);
}
